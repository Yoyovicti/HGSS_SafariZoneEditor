...
public:
    Mesh(const aiMaterial* material, const aiMesh* mesh, const std::filesystem::path& model_dir, const QVector3D& xyz_offset, const QVector3D& scale);
...
private:
    ...
    void processVertices(const aiMesh* mesh, const QVector3D& xyz_offset, const QVector3D& scale);
